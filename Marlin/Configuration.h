...
#define STRING_CONFIG_H_AUTHOR "(github.com/jdudick)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Hyper"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -33, 1, -.92 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 150), (Y_MIN_POS + 10), 20 }
